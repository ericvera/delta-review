...
37. Clear Resolved (view title `$(clear-all)`) → resolved notes vanish from the file, the threads, and the ref; open/addressed notes untouched; clicking again is a no-op (file mtime unchanged).
